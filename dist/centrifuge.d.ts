...
declare class Centrifuge extends EventEmitter {
    ...
    subscribe(channel: string, events?: (...args: any[]) => void, options?: any): Centrifuge.Subscription;
    subscribe(channel: string, events?: Centrifuge.SubscriptionEvents, options?: any): Centrifuge.Subscription;
}
